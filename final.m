...
% Loop to change boys position by 'walking'
numSteps = 100;
for step = 1:numSteps
...
ideal = [10,-4,-32.49]; %ideal position for the woman to go
numSteps = 100;
idealx = (10-1.5)/numSteps;
idealy = (4-3)/numSteps;
idealz = (42.32-34.32)/numSteps; % the difference of the ideal position and her actual position
